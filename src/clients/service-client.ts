...
class ServiceClient {
    async createService(data: CreateServiceRequest): Promise<ApiResponse<ServiceDto>> {
        ...
        const response = await baseClient.post<ApiResponse<ServiceDto>>('/Service', formData, {
            headers: {
