    ...
    <section className="relative">
      ...
      <div className="grid md:grid-cols-2">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: '-20% 0px -20% 0px' }}
          className="bg-primary text-background p-12 md:p-20"
        >
          <h2
          ...
          <div className="space-y-8">
            ...
            >
              <HiLocationMarker className="w-5 h-5 text-background/60 mt-1" />
              <div>
                <p className="text-sm text-background/60 mb-1">Ubicación</p>
                <p className="text-lg">Nicanor Plaza 1070, local 2</p>
                <p className="text-background/60">Antofagasta, Chile</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex items-start space-x-4"
            >
              <FaInstagram className="w-5 h-5 text-background/60 mt-1" />
              <div>
                <p className="text-sm text-background/60 mb-1">Instagram</p>
            ...
            <motion.div
              ...
              className="flex items-start space-x-4"
            >
              <HiClock className="w-5 h-5 text-background/60 mt-1" />
              <div>
                <p className="text-sm text-background/60 mb-1">Horario</p>
          ...
          <motion.p
            ...
            viewport={{ once: true, margin: '-20% 0px -20% 0px' }}
            className="mt-16 text-2xl italic text-background/60"
            style={{ fontFamily: 'var(--font-playfair)' }}
          >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true, margin: '-20% 0px -20% 0px' }}
          className="bg-accent/20 p-12 md:p-20 flex flex-col justify-center items-center text-center"
        >
          <motion.div
          ...
          >
            <HiCalendar className="w-12 h-12 text-background" />
          </motion.div>
